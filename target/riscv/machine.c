...
static bool debug_needed(void *opaque)
{
    ...
    return cpu->cfg.debug &&
           mcc->def->debug_cfg->nr_triggers == OLD_RV_MAX_TRIGGERS &&
...
static int debug_pre_save(void *opaque)
{
    ...
    for (i = 0; i < OLD_RV_MAX_TRIGGERS; i++) {
...
static const VMStateDescription vmstate_debug = {
    ...
    .fields = (const VMStateField[]) {
        ...
        VMSTATE_UINTTL_ARRAY(env.old_tdata1, RISCVCPU, OLD_RV_MAX_TRIGGERS),
        VMSTATE_UINTTL_ARRAY(env.old_tdata2, RISCVCPU, OLD_RV_MAX_TRIGGERS),
        VMSTATE_UINTTL_ARRAY(env.old_tdata3, RISCVCPU, OLD_RV_MAX_TRIGGERS),
        VMSTATE_END_OF_LIST()
    }
};
 ...
 * for machines that have other than 2 triggers.
 */
